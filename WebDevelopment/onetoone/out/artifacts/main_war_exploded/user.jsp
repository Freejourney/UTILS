...
<%@ page import="ssm.pojo.MetaTracks" %>
...
<%!
    List<MetaTracks> metaTracks = new ArrayList<MetaTracks>();
    int i = 0;
%>
<!DOCTYPE html>
...
<head>
    ...
    <script>
        $(document).ready(function(e) {
            ...
            $.ajax({
                type:"get",
                url:"${pageContext.request.contextPath}/userfavo/getfavo",
                data:{"uid":"0"},
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success:function(data) {
                    var recordlist=data;
                    metaTracks = recordlist.data;
                    var v = recordlist.data[0];
                    var t = v.song;
                    // alert(v.get("song"));
                                        ...
                                        <ul class="list-group list-group-lg no-bg auto m-b-none m-t-n-xxs">
                                            ...
                                            <li class="list-group-item clearfix">
                                                <a href="#" class="jp-play-fun pull-right m-t-sm m-l text-md">
                                                    <i class="icon-control-play text"></i>
                                                    <i class="icon-control-pause text-active">123</i>
                                                </a>
                                                <a href="#" class="jp-play-fun pull-right m-t-sm m-l text-md">
                                                    <i class="icon-control-play text"></i>
                                                    <i class="icon-control-pause text-active"></i>
                                                ...
                                                <a class="clear" href="#">
                                                    <span class="block text-ellipsis">song</span>
